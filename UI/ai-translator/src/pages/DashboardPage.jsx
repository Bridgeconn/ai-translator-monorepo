  ...
  const aboutContent = (
    ...
    >
      ...
      <p style={{ marginBottom: 12 }}>
        ...
        It provides real-time translation assistance, smart text comparison, and
      ...
      <div style={{ fontSize: 14, color: "rgba(0,0,0,0.65)" }}>
        ...
        <div style={{ fontSize: 14, lineHeight: 1.6 }}>
          ...
          <ul style={{ paddingLeft: 18, marginBottom: 16 }}>
            ...
            <li>
              Restrict deleting <code>sample.txt</code> in Text Document
              Translation
            </li>
            <li>Chapter-wise download and copy options</li>
            <li>
              Hardcoded language for reverse translation (bidirectional models)
            </li>
          ...
          <ul style={{ paddingLeft: 18 }}>
            ...
            <li>
              Fixed language dropdown on Project & Quick Translation pages
            </li>
  ...
  return (
    ...
    >
      ...
      <Modal
        ...
        centered
        width={600}
        title={<strong>What’s New — Version 1.0.0 🚀</strong>}
        bodyStyle={{
          maxHeight: "70vh",
          overflowY: "auto",
          scrollbarWidth: "none",
