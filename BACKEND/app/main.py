...
from app.routes import users as user_routes, languages,sources as source_routes,\
 ...
 word_token_translation, word_tokens,verse_tokens, translationdraft
...
app.include_router(translationdraft.router, prefix="/translation-drafts", tags=["Translation Drafts"])
