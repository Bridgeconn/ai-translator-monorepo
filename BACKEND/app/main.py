...
#from BACKEND.app.routes import verse_tokens
from app.routes import verse_tokens
from app.routes import users as user_routes, languages,sources as source_routes,\
 ...
 word_token_translation, word_tokens
...
#app.include_router(verse_tokens.router, tags=["Verse Tokens"])
