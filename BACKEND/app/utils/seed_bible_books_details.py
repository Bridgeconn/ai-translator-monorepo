...
def seed_book_details():
    db: Session = SessionLocal()
    try:

        # Check if any data exists in the BookDetail table
        existing_data = db.query(BookDetail).first()
        if existing_data:
            print("Book Data already exists in the BookDetail table.")
            return
